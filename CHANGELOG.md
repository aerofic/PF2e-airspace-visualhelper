...
- Increased 3D airspace Token miniatures from 30 px to 45 px and rebalanced their node, label, distance, and Target-control spacing for better identification.
